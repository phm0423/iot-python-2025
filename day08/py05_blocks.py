...
class Block:
    def __init__(self, col, rect, speed = 0):
        ...
        self.rect= rect
        self.speed = speed
        self.dir = random.randint(-45, 45) + 270    # 3+270

    def move(self): # 볼 무브
        # 볼의 움직이는 x축값을 계속 계산하려면 x은 dir 값을 라디언으로 변환 후 코사인 처리
        self.rect.centerx += math.cos(math.radians(self.dir)) * self.speed
        # 볼의 움직이는 y축값을 계속 계산하려면 y은 dir 값을 라디언으로 변환 후 사인 처리
    ...
    while True:
        ...
        if is_game_start == False:
            ...
            if BALL.rect.centerx < 10 or BALL.rect.centerx > SCREEN_WIDTH-10:   # 게임화면 양쪽 벽 밖으로 못나가게
                BALL.dir = 180 - BALL.dir   # 반사각만큼 방향 전화
            elif BALL.rect.centery < 10 :    ## 게임 화면 천장에 부딪히면 반사
                BALL.dir = -BALL.dir
